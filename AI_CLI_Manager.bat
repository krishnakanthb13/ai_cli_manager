...
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\junie" /ve /d "Open with Junie CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\junie" /v "Icon" /d "%ICONS_DIR%\junie_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\junie\command" /ve /d "cmd.exe /c start wt.exe -d \"%%V\" cmd /k junie" /f >nul

reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\kiro" /ve /d "Open with Kiro CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\kiro" /v "Icon" /d "%ICONS_DIR%\kiro_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\kiro\command" /ve /d "cmd.exe /c start wt.exe -d \"%%V\" cmd /k \"\"%SCRIPT_DIR%Batch Files\LaunchKiro.bat\"\"" /f >nul

reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\qoder" /ve /d "Open with Qoder CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\qoder" /v "Icon" /d "%ICONS_DIR%\qoder_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\Background\shell\AI_CLI_Menu_Primary\shell\qoder\command" /ve /d "cmd.exe /c start wt.exe -d \"%%V\" cmd /k qodercli" /f >nul
...
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\junie" /ve /d "Open with Junie CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\junie" /v "Icon" /d "%ICONS_DIR%\junie_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\junie\command" /ve /d "cmd.exe /c start wt.exe -d \"%%1\" cmd /k junie" /f >nul

reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\kiro" /ve /d "Open with Kiro CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\kiro" /v "Icon" /d "%ICONS_DIR%\kiro_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\kiro\command" /ve /d "cmd.exe /c start wt.exe -d \"%%1\" cmd /k \"\"%SCRIPT_DIR%Batch Files\LaunchKiro.bat\"\"" /f >nul

reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\qoder" /ve /d "Open with Qoder CLI" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\qoder" /v "Icon" /d "%ICONS_DIR%\qoder_v2.ico" /f >nul
reg add "HKEY_CLASSES_ROOT\Directory\shell\AI_CLI_Menu_Primary\shell\qoder\command" /ve /d "cmd.exe /c start wt.exe -d \"%%1\" cmd /k qodercli" /f >nul
